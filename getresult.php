...
<form name="frmSearch" method="post" action="index.php">
    <div class="search-box">
        <p>
            ...
            <input type="text" placeholder="Name" name="name" id="name" class="demoInputBox" value="<?php echo $name; ?>"/>
            <input type="text" placeholder="Code" name="code" id="code" class="demoInputBox" value="<?php echo $code; ?>"/>
